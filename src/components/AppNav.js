...
export default function AppNav({ currentApp }) {
  ...
  return (
    <div style={{ position:'sticky', top:0, zIndex:100, background:'#1A1009', borderBottom:'1px solid #3D3525', padding:'0 24px', height:40, display:'flex', alignItems:'center', justifyContent:'space-between' }}>
